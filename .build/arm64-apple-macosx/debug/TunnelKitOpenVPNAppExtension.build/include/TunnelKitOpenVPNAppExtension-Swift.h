...
#ifndef TUNNELKITOPENVPNAPPEXTENSION_SWIFT_H
#define TUNNELKITOPENVPNAPPEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TunnelKitOpenVPNAppExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSObject;
/// Provides an all-in-one <code>NEPacketTunnelProvider</code> implementation for use in a
/// Packet Tunnel Provider extension both on iOS and macOS.
SWIFT_CLASS("_TtC28TunnelKitOpenVPNAppExtension21OpenVPNTunnelProvider")
